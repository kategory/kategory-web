**Aufgabenstellung:**  
Erstelle aus der Markdown-Datei *blog.md* eine statische HTML-Webseite.

**Struktur:**

1. **Übersichtsseite:** Eine Hauptseite, die alle Blogeinträge auflistet.  
...
* **Grunddesign:** Verwende für die Übersichtsseite und die Detailseiten das Framework Bootstrap, orientiert an der Struktur der Datei *logismy.html* (Indexseite des Schwesterprojekts).  
